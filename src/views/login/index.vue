    ...
    >
      ...
      <div>
        <el-button
          class="el-button el-button--primary"
          type="primary"
          @click.native.prevent="handleAuth0"
        >
          {{ $t('auth0.title') }}
        </el-button>
      </div>
      ...
      <div>
        <el-button
          class="el-button el-button--primary"
          type="primary"
          @click.native.prevent="handleLP2"
        >
          {{ $t('LP2.title') }}
        </el-button>
      </div>
      ...
      <el-button :loading="loading"
        type="primary"
        style="width:100%; margin-bottom:30px;"
        v-if="!$auth.isAuthenticated" @click="login"> {{ $t('login.logIn') }} OAUTH</el-button>
      <!-- show logout when authenticated -->
      <el-button v-if="$auth.isAuthenticated" @click="logout">Log out</el-button>
    </div>
<!--
