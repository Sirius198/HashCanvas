export default {
  route: {
    ...
    scaled_orders: 'Scaled orders',
    market_place: 'Market Place',
    order_settings: 'Settings',
    new_strategy: 'Create a new Strategy',
    my_bundles: 'My Bundles',
    search_automations: 'Search Automations',
    new_automations: 'New Automations',
    my_automations: 'My Automations',
    my_strategy: 'My Strategies',
    browse_strategy: 'Browse Strategies',
    guide: 'Guía',
    permission: 'Permisos',
